...
export declare function initProperty(name: string, key: string, whatis: WhatIsIt): {
    [path: string]: Function[] | typeof mongoose.SchemaType | mongoose.Schema<any, any, any, any> | readonly mongoose.Schema<any, any, any, any>[] | mongoose.Schema<any, any, any, any>[] | mongoose.SchemaTypeOptions<any> | readonly mongoose.SchemaTypeOptions<any>[] | any | readonly any[] | mongoose.SchemaTypeOptions<any>[] | any[];
};
/**
 ...
 */
export declare function mapArrayOptions(rawOptions: any, Type: AnyParamConstructor<any> | mongoose.Schema, target: any, pkey: string, loggerType?: AnyParamConstructor<any>, extra?: KeyStringAny): mongoose.SchemaTypeOpts<any>;
/**
 * Map Options to "inner" & "outer"
 * @param rawOptions The raw options
 * @param Type The Type of the array
